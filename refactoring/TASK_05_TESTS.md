...
- [ ] 5.1. Добавить тесты геометрии шпильки типа 2.1
- [ ] 5.2. Добавить тесты геометрии плиты
- [ ] 5.3. Добавить тесты типа плиты
- [ ] 5.4. Добавить тесты сборки типа 2.1
- [ ] 5.5. Запустить все тесты проекта
- [ ] 5.6. Исправить ошибки (если есть)
- [ ] 5.7. Закоммитить изменения

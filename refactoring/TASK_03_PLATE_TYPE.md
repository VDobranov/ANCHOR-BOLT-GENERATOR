...
- [x] 3.1. Изучить существующие методы создания типов в `TypeFactory`
- [x] 3.2. Добавить метод `get_or_create_plate_type()` в класс `TypeFactory`
- [x] 3.3. Реализовать кэширование типов плит
- [x] 3.4. Реализовать создание `IfcMechanicalFastenerType` для плиты
- [x] 3.5. Реализовать ассоциацию геометрии через `create_plate_solid()`
- [x] 3.6. Реализовать ассоциацию материала
- [x] 3.7. Добавить тесты типа плиты
- [x] 3.8. Запустить все тесты проекта (152 passed, 2 skipped)
- [x] 3.9. Закоммитить изменения (коммит 0d01b0f)

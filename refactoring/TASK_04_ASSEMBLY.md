...
- [x] 4.1. Изучить текущую реализацию `create_bolt_assembly()` для типа 2.1
- [x] 4.2. Добавить флаг `has_plate = bolt_type == "2.1"`
- [x] 4.3. Добавить получение типа плиты через `get_or_create_plate_type()`
- [x] 4.4. Рассчитать позиции компонентов (шпилька, гайки, плита)
- [x] 4.5. Создать нижнюю гайку 2 (самая нижняя)
- [x] 4.6. Создать анкерную плиту (между гайками)
- [x] 4.7. Создать нижнюю гайку 1 (над плитой)
- [x] 4.8. Создать шпильку (Z=0 на начале резьбы)
- [x] 4.9. Создать верхние компоненты (шайба, гайки)
- [x] 4.10. Добавить тесты сборки типа 2.1
- [x] 4.11. Запустить все тесты проекта (152 passed, 2 skipped)
- [x] 4.12. Закоммитить изменения (коммит b6f9618)

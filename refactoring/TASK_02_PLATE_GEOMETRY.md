...
- [x] 2.1. Изучить существующие методы создания геометрии в `GeometryBuilder`
- [x] 2.2. Добавить метод `create_plate_solid()` в класс `GeometryBuilder`
- [x] 2.3. Реализовать создание квадратного профиля с круглым отверстием
- [x] 2.4. Реализовать экструзию профиля
- [x] 2.5. Добавить тесты геометрии плиты
- [x] 2.6. Запустить все тесты проекта (152 passed, 2 skipped)
- [x] 2.7. Закоммитить изменения (коммит 7ca17b4)

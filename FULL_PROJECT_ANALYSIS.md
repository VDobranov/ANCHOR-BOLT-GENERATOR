...
**Примечание:** Доступные длины зависят от диаметра и типа болта, генерируются автоматически из `BOLT_DIM_DATA` на основе наличия массы.

**Детализация по диаметрам:**
- **Тип 1.1, 1.2:** М12: 300–1000 | М16: 300–1250 | М20: 400–1400 | М24: 500–1700 | М30: 600–2000 | М36: 710–2300 | М42: 800–2500 | М48: 900–2800
- **Тип 2.1:** М16: 200–1250 | М20: 200–1500 | М24: 250–1700 | М30: 250–1900 | М36: 300–2240 | М42: 350–2500 | М48: 400–2800
- **Тип 5:** М12: 150–450 | М16: 150–600 | М20: 150–800 | М24: 200–900 | М30: 250–1120 | М36: 300–1250 | М42: 350–1320 | М48: 400–1400
...
**Позиционирование шпильки:**

| Тип | Геометрия | Placement | Итоговая позиция |
|-----|-----------|-----------|------------------|
| 1.1, 1.2 | Z=0 до Z=+L | Z=+l₀ | Z=0 до Z=+L (низ резьбы в Z=0) |
| 2.1, 5 | Z=0 до Z=+L | Z=+l₀, ось↓ | Z=-(L-l₀) до Z=+l₀ (низ резьбы в Z=0) |
...
**Пример для М20x300:**
- l₀ = 100 мм, L = 300 мм
- Тип 2.1, 5: шпилька от Z=-200 до Z=+100
- Z=0: низ резьбы

**Позиционирование компонентов типа 2.1:**
- **Гайка 2 (нижняя):** центр на Z = stud_bottom + 18
- **Плита:** центр на Z = stud_bottom + 34
- **Гайка 1:** центр на Z = stud_bottom + 50
- **Z=0:** низ резьбы
- **Шпилька:** от Z=-200 до Z=+100

### Анкерные плиты (тип 2.1)
...
**Материал плит:** Сталь 09Г2С, Сталь 40Х, Сталь 40Г2

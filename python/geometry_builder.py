...
class GeometryBuilder:
    ...
    def create_composite_curve_stud(self, bolt_type, diameter, length):
        ...
        Для типа 5 (прямой болт с резьбой на всю длину): прямая линия длиной L с резьбой l0

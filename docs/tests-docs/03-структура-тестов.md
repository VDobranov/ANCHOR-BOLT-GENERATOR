...
```
js/tests/
├── setup.js                       # Mock глобальных объектов (THREE, DOM, UI)
├── README.md                      # Документация по тестированию JS
├── validationService.test.js      # Тесты validationService (25 тестов)
├── helpers.test.js                # Тесты helpers (23 теста)
├── constants.test.js              # Тесты constants (4 теста)
├── config.test.js                 # Тесты config (11 тестов)
├── dom.test.js                    # Тесты DOM утилит (22 теста)
└── status.test.js                 # Тесты statusManager (12 тестов)
```

**Всего: 97 тестов, покрытие 98%**

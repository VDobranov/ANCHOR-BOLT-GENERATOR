...
class TestCreateStraightStudSolid:
    ...
    def test_create_straight_stud_solid(self):
        ...
        with patch.object(builder, '_get_context', return_value=mock_context), \
             patch.object(builder.builder, 'circle') as mock_circle, \
             patch.object(builder.builder, 'profile') as mock_profile, \
             patch.object(builder.builder, 'extrude') as mock_extrude, \
             patch.object(builder, '_create_shape_representation') as mock_repr:
...
class TestCreateBentStudSolid:
    ...
    def test_create_bent_stud_solid_type_1_1(self):
        ...
        with patch.object(builder, '_get_context', return_value=mock_context), \
             patch.object(builder.builder, 'create_swept_disk_solid') as mock_swept, \
             patch.object(builder, '_create_shape_representation') as mock_repr:
...
class TestCreateNutSolid:
    ...
    def test_create_nut_solid(self):
        ...
        with patch.object(builder, '_get_context', return_value=mock_context), \
             patch.object(builder.builder, 'polyline') as mock_polyline, \
             patch.object(builder.builder, 'circle') as mock_circle, \
             patch.object(builder.builder, 'profile') as mock_profile, \
             patch.object(builder.builder, 'extrude') as mock_extrude, \
             patch.object(builder, '_create_shape_representation') as mock_repr:

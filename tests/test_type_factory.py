...
class TestGetOrCreateStudType:
    ...
    def test_get_or_create_stud_type_creates_entity(self):
        ...
        with patch.object(factory.builder.builder, 'polyline', return_value=MockIfcEntity('IfcIndexedPolyCurve')), \
             patch.object(factory.builder.builder, 'create_swept_disk_solid', return_value=MockIfcEntity('IfcSweptDiskSolid')), \
             patch.object(factory.builder.builder, 'circle', return_value=MockIfcEntity('IfcCircle')), \
             patch.object(factory.builder.builder, 'profile', return_value=MockIfcEntity('IfcArbitraryProfileDefWithVoids')), \
             patch.object(factory.builder.builder, 'extrude', return_value=MockIfcEntity('IfcExtrudedAreaSolid')), \
             patch.object(factory.builder.builder, 'get_representation', return_value=mock_shape_rep):
...
class TestGetOrCreateWasherType:
    ...
    def test_get_or_create_washer_type_creates_entity(self):
        ...
        mock_shape_rep = MockIfcEntity('IfcShapeRepresentation')
        with patch.object(factory.builder.builder, 'circle', return_value=MockIfcEntity('IfcCircle')), \
             patch.object(factory.builder.builder, 'profile', return_value=MockIfcEntity('IfcArbitraryProfileDefWithVoids')), \
             patch.object(factory.builder.builder, 'extrude', return_value=MockIfcEntity('IfcExtrudedAreaSolid')), \
             patch.object(factory.builder.builder, 'get_representation', return_value=mock_shape_rep):
